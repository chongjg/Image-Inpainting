...
def load_config(mode=None):
    ...
    # test mode
    if mode == 2:
        parser.add_argument('--input', type=str, default='./tmp/input', help='path to the input images directory or an input image')
        parser.add_argument('--mask', type=str, default='./tmp/mask', help='path to the masks directory or a mask file')
        parser.add_argument('--edge', type=str, help='path to the edges directory or an edge file')
        parser.add_argument('--output', type=str, default='./tmp/output', help='path to the output directory')
